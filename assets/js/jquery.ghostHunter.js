...
(function( $ ) {
	...
	$.fn.ghostHunter.defaults = {
		...
		rss 				: "/rss",
		onKeyUp 			: false,
		result_template 	: "<article id=\"post\" class=\"single group\"><section class=\"p-meta\"><div class=\"meta-date result\">{{pubDate}}</div></section><div class=\"group\"><h2><a href='{{link}}'>{{title}}</a></h2></div></article>",
